...
import chart1 from '@/assets/landing/chart-1.png';
import chart2 from '@/assets/landing/chart-2.png';
...
const RegisteredCarsNumberSection = () => {
  ...
  const rentalOpacity = useTransform(scrollYProgress, [0.2, 0.45], [0, 1]);
  const rentalY = useTransform(scrollYProgress, [0.2, 0.45], [24, 0]);
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-y-6">
        <div className="relative">
          <motion.div style={{ opacity: carOpacity, y: carY }}>
            <CarPercentage />
          </motion.div>
        ...
        <div className="relative">
          <motion.div style={{ opacity: rentalOpacity, y: rentalY }}>
            <RentalPercentage />
          </motion.div>
