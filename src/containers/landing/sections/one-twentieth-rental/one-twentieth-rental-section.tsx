  ...
  return (
    <section className="flex flex-col items-center justify-center gap-y-20 sticky top-0 z-0">
      <Image
        src={roadSmallImg}
        alt="도로 위 차량"
        className="w-full max-h-screen xl:hidden object-cover"
      />
      <Image
        src={roadLargeImg}
        alt="도로 위 차량"
      ...
      <div className="absolute inset-0 z-[2] flex flex-col items-center justify-center gap-y-10 xl:p-60 mb-[100px] xl:mb-[400px]">
        <TwoRowText firstLine="지금 도로 위 차량" secondLine="20대 중 1대는 렌터카" />
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3, delay: 0.5 }}
          className="flex flex-col justify-start items-center gap-y-1 xl:gap-y-2 text-white text-sm xl:text-28"
        >
